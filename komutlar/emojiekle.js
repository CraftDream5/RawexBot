...
exports.run = (client, message, args) => {
 ...
 if(!message.member.hasPermission("MANAGE_EMOJIS")) return message.channel.send("⛔ Bu komutu kullanabilmek için `Emojileri Yönet` yetkisine sahip olmalısınız.").then(msg => msg.delete({timeout:100000}))
    let link = args[0]
    let isim = args[1];
