  ...
  if (
    ...
    message.channel.send(
      new Discord.MessageEmbed()
        .setColor("#ffff00")
        .setDescription(`Bilet ${message.author} tarafından kapatıldı.`).setTimestamp()
    ...
    message.channel
      .send(
        new Discord.MessageEmbed().setColor("RED")
          .setDescription(`:unlock:: Ticketi tekrar açar. :no_entry:: Ticketi siler.`).setTimestamp()
      .setFooter(`Rawex Ticket Sistemi`,client.user.avatarURL())
      )
      .then(m => {
        m.react("🔓");
      ...
      .setFooter(`Rawex Ticket Sistemi`,client.user.avatarURL())
        ...
        sill.on("collect", async reaction => {
          ...
          message.channel.send(
            new Discord.MessageEmbed()
              .setColor("RED")
              .setDescription(`Bilet 5 saniye sonra ebediyen silinecek.`).setTimestamp()
      .setFooter(`Rawex Ticket Sistemi`,client.user.avatarURL())
          );
          setTimeout(async () => {
